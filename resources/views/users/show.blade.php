        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ __('base.position') }}</h5>
                    ...
                    <form action="{{ route('user.update-position') }}" method="POST">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary"
                                data-bs-dismiss="modal">{{ __('base.cancel') }}</button>
        ...
        function showModalForm(userId) {
            ...
            fetch("{{ url('webapi/user') }}/" + userId)
                ...
                .then(user => {
                    ...
                    const positionText = user.position_name ||
                    'Unknown Position'; // Pastikan server mengembalikan nama posisi
